 ...
 */
public class N33_ZKBEntry extends BaseDBObject {


    private static final long serialVersionUID = -8469434805717122190L;

    public N33_ZKBEntry(BasicDBObject baseEntry) {
        super(baseEntry);
    }
    ...
    public N33_ZKBEntry(int x, int y, ObjectId classroomId,ObjectId schoolId,ObjectId termId,Integer week,ObjectId userId,ObjectId nJxbId,ObjectId nsubId,ObjectId ntid,ObjectId cid) {
        this(x,y,classroomId,null,0,null,null,null,schoolId,termId,week,userId,System.currentTimeMillis(),nJxbId,nsubId,ntid,cid);
    }
    public N33_ZKBEntry(int x, int y, ObjectId classroomId,ObjectId jxbId,int isUse,ObjectId subjectId,
