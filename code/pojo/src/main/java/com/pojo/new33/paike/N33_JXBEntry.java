 ...
 */
public class N33_JXBEntry extends BaseDBObject {
    private static final long serialVersionUID = 767419300390478812L;

    public N33_JXBEntry(BasicDBObject baseEntry) {
        super(baseEntry);
    }
    ...
    public int getAcClassType() {
        return getSimpleIntegerValueDef("acty", 0);
    }

    public void setAcClassType(int acClassType) {
        setSimpleValue("acty", acClassType);
    }

    public int getTimeCombSerial() {
        return getSimpleIntegerValueDef("serial", 0);
    }
    ...
    public int getSerialState(){
        return getSimpleIntegerValueDef("serialState", 0);
    }

    public void setSerialState(int serialState) {
        setSimpleValue("serialState", serialState);
    }

    public String getSubName(){
        return getSimpleStringValueDef("subName","");
    }
    public void setSubName(String subName){
        setSimpleValue("subName", subName);
    }
    ...
    public boolean equals(Object obj) {
        if (obj != null && (obj.getClass().equals(getClass()))) {
            N33_JXBEntry n33_jxbEntry = (N33_JXBEntry) obj;
