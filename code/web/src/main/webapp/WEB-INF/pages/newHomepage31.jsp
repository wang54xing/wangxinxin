            ...
            <a id="ct_1_2" href="javascript:;" class="pageview-IV newPage-right-pageview newPage-right-none">
                ...
                <c:choose>
                    ...
                    <c:when test="${roles:isHeadmaster(sessionValue.userRole)}">
                        <a href="/score/header.do?version=5&index=3" class="pageview-II newPage-right-pageview">
                            <img class="newpage-WK newPage-shadow" src="/customizedpage/newspage/img/newLogoo-5.png">
                        </a>
                    </c:when>
                    <c:otherwise>
                        <a href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
              ...
              <!--=====================互动课堂=========================-->
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="/interactLesson/lanclass.do?index=4" class="newPage-right-pagevieww">
                            <img class="newpage-WK newPage-shadow" src="/customizedpage/newspage/img/newLogoo-13.png">
                        </a>
                    </c:otherwise>
                </c:choose>
              <!--=====================办公OA=========================-->
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="javascript:;"  class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
              ...
              <!--新增图片-->
                <a style="float: left;width:514px; ">
                    <img src="/images/homepage-p-1.gif">
                </a>
              <!--=====================微课超市=========================-->
                <a id="ct_7_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPage-right-none">
                    <img class="" src="../../customizedpage/newspage/img/newLogoo-17-H.png">
                    <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
                </a>
                <a id="ct_7_2" href="/emarket?index=8&version=1" class="newPage-right-pagevieww newPage-right-block">
                    <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-17.png">
                </a>
         <%--     <!--=====================云资源=========================-->
              <a id="ct_8_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-none">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-18-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_8_2" href="/cloud/cloudLesson.do?index=9&version=1&type=1" class="newPage-right-pagevieww newPage-right-block">
            ...
            <%--  <!--=====================兴趣拓展课=========================-->
              <a id="ct_9_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-none">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-19-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_9_2" href="/myclass/tointerestclass?index=10" class="newPage-right-pageview newPage-right-block ">
              ...
              <!--=====================火热活动=========================-->
              <a id="ct_10_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-none">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-20-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_10_2" href="/business/fieryactivitylist.do?index=11" class="newPage-right-pageview newPage-right-block">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-20.png">
              </a>
              <!--=====================群组交流=========================-->
              <a id="ct_11_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-none ">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-21-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_11_2" href="/chat?index=12" class="newPage-right-pagevieww newPage-right-block">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-21.png">
              </a>
                <!--新增图片-->
                <a style="float:left;width: 125px;">
                    <img src="/images/homepage-p-2.png">
                </a>
                <a style="float: left;width: 258px;">
                    <img src="/images/homepage-p-3.gif">
                </a>
                <a style="float: left;width: 258px;">
                    <img src="/images/homepage-p-4.gif">
                </a>
          <%--    <!--=====================平台管理=========================-->
              <a id="ct_17_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-none">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-27-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_17_2" href="/myschool/managesubject?index=18&version=1&tag=1" class="newPage-right-pagevieww newPage-right-block">
              ...
              <c:choose>
                  ...
                  <c:otherwise>
                      <a href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover" style="display: block!important;width: 122px;;" >
