      ...
      <dd>
        ...
        <div class="newPage-right">
          <dl>
            <dd>
              <!--===================家校互动==========================-->
              <a id="ct_1_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
              ...
              <a id="ct_1_2" href="javascript:;" class="pageview-IV newPage-right-pageview newPage-right-none">
              ...
              <!--===================微课@翻转课堂==========================-->
              <a id="ct_2_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
                <img class="w" src="../../customizedpage/newspage/img/newLogoo-5-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_2_2" href="javascript:;" class="pageview-II newPage-right-pageview newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-5.png">
              </a>
              <!--=====================互动课堂=========================-->
              <a id="ct_3_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-13-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_3_2" href="/interactLesson/lanclass.do?index=4&version=1" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-13.png">
              </a>
              <!--=====================办公OA=========================-->
              <a id="ct_4_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-14-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_4_2" href="/docflow/documentList.do?type=0&index=5&version=1"  class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-14.png">
              </a>
              <!--=====================学生综合素质=========================-->
              <a id="ct_5_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-15-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_5_2" href="/growth/list.do?index=6" class="newPage-right-pageview newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-15.png">
              </a>
              <!--=====================3+3走班教学=========================-->
              <a id="ct_6_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-16-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_6_2" href="/zouban/baseConfig.do?index=7&version=1" class="newPage-right-pageview newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-16.png">
              </a>
              <!--=====================微课超市=========================-->
              <a id="ct_7_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-17-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_7_2" href="/emarket?index=8&version=1" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-17.png">
              </a>
              <!--=====================云资源=========================-->
              <a id="ct_8_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-18-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_8_2" href="/cloud/cloudLesson.do?index=9&version=1&type=1" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18.png">
              </a>
              <!--=====================兴趣拓展课=========================-->
              <a id="ct_9_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-19-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_9_2" href="/myclass/tointerestclass?index=10" class="newPage-right-pageview newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-19.png">
              </a>
              <!--=====================火热活动=========================-->
              <a id="ct_10_1" href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-20-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_10_2" href="/business/fieryactivitylist.do?index=11" class="newPage-right-pageview newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-20.png">
              </a>
              <!--=====================群组交流=========================-->
              <a id="ct_11_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-21-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_11_2" href="/chat?index=12" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-21.png">
              </a>
              <!--=====================阅卷系统=========================-->
              <a id="ct_12_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-22-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_12_2" href="javascript:;" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-22.png">
              </a>
              <!--=====================校园安全监控=========================-->
              <a id="ct_13_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-23-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_13_2" href="/schoolSecurity/schoolSecurityPage.do?index=14" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-23.png">
              </a>
              <!--=====================直播点播=========================-->
              <a id="ct_14_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-24-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_14_2" href="javascript:;" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-24.png">
              </a>
              <!--=====================一卡通=========================-->
              <a id="ct_15_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-25-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_15_2" href="javascript:;" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-25.png">
              </a>
              <!--=====================教师评价系统=========================-->
              <a id="ct_16_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-26-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_16_2" href="javascript:;" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-26.png">
              </a>
              <!--=====================平台管理=========================-->
              <a id="ct_17_1" href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-block">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-27-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a id="ct_17_2" href="/myschool/managesubject?index=18&version=1&tag=1" class="newPage-right-pagevieww newPage-right-none">
                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
              </a>
              <!--=====================APP下载=========================-->
              <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover newPage-right-none">
                <img class="" src="../../customizedpage/newspage/img/newLogoo-28-H.png">
                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
              </a>
              <a href="/mobile" class="newPage-right-pagevieww newPage-right-block">
      ...
      success: function (data) {
        if (data!=null &&data.length!=0) {
          for(var i=0;i<data.length;i++) {
            var id = data[i].id;
            var url = data[i].link;
          $('#'+id+'_1').removeClass('newPage-right-block');
          $('#'+id+'_2').removeClass('newPage-right-none');
            $('#'+id+'_2').attr('href',url);
          }
        }
      }
