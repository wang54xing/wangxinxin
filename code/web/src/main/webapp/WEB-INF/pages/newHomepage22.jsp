                    ...
                    <dl>
                        ...
                        <dd>
                           ...
                           <%-- <a href="/schoolSecurity/schoolSecurityPage.do?version=30" class="pageview-I newPage-right-pageview">
                            ...
                            <c:choose>
                                <c:when test="${(roles:isTeacher(sessionValue.userRole))}">
                                    <a href="http://221.214.55.21:8088/dsideal_yy/html/ypt/main/main.html" class="pageview-II newPage-right-pageview">
                         ...
                         <%--   <!--===================资源中心==========================-->
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/cloud/cloudLesson.do?index=9&version=1&type=1" class="newPage-right-pagevieww" style="width: auto;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18-1.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/cloudres/load.do?index=9&version=3" class="newPage-right-pagevieww" style="width: auto;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18-1.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                ...
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover" style="display: block!important;width: 100px;;">
                            ...
                            <a class="newPage-right-pagevieww" href="/chat?index=12" style="width: auto;">
                                <img src="../../customizedpage/newspage/img/newLogoo-21-1.png" class="newpage-WK newPage-shadow">
                            </a>
                           ...
                           -->
                            ...
                            <!--=====================教师评价系统=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="width: auto;">
                                <img class="" src="../../customizedpage/newspage/img/newLogoo-26-1.png">
                            </a>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display: block;width: auto;">
                                        <img class="" src="../../customizedpage/newspage/img/newLogoo-26-2.png">
                                            <%--<img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">--%>
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <a href="/mobile" class="newPage-right-pagevieww" style="width: 251px;">
                                <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-28-1.png">
                            </a>
                            <%--<!--===================学校管理==========================-->
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) ||
