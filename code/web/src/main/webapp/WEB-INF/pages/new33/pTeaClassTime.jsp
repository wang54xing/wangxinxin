...
<head>
  ...
  <style type="text/css">
    *{
    ...
    .dc .b9{ background: #2e94db; margin-right: 0 !important;}
    .fixedcont{
      width: 220px;
      position: fixed;
      top: 495px;
...
<div class="right-pos">
  ...
  <a href="/newisolatepage/pTeaClassTime.do" class="pkt2">教师课表</a>
...
<div class="container clearfix">
  <div class="clearfix">
      ...
      <ul class="ul-main">
        ...
        <script type="text/template" id="subject2_temp">
  ...
  <div class="container clearfix conhide">
    <div class="fl w225">
     ...
     <div class="fr w940 mr10" id="GDGContent">
      <div class = "dc">
        <div><em class="f18 c-b" id="userName" style="display: inline-block"></em><em class="f18 c-b" id="keCount"style="display: inline-block"></em> </div>
        <button class="b11 fr mtt41 wucx" id="wkcx" style="margin-right: -7px;">教师无课查询</button>
        <button class="b9 fr mtt41 mr133">导出当前教师课表</button>
          <button class="b10 fr mtt41 mr301">批量导出</button>
        <button class="b8 fr mtt41 mr415" id="printGDG">打印</button>
        <select class="sel1 fr mtt41 mr500" type="text" id="week">
      	</select>
...
<div class="popup dc-popup">
    ...
    <div class="wuUl">
        ...
        <span>科目</span>
        <select class="sel162 mrl10 mt10" id="subject2">
    ...
    <div class="teacherdc" id="teacherList">
...
<div class="popup you-popup">
    ...
    <div class="wuUl">
        <span>年级</span>
        <select class="sel162 mrl10 grade" id="grade1">
...
<script>
  seajs.use('pTeaClassTime', function (pTeaClassTime) {
    pTeaClassTime.init();
  });
</script>
</html>