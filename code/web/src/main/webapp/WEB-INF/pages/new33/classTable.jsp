...
<div class="right-pos" style="top: -111px;">
    ...
    <a href="/newisolatepage/classTable.do" class="pkb2">行政班课表</a>
</div>
<div class="container clearfix">
    ...
    <div class="container clearfix">
        <div class="fl w225">
            <div class="f18 c-b">班级列表<em class="c-3c classCount"></em></div>
        ...
        <div class="fr w940 mr10" id="GDGContent">
            <div class = "dc">
                <div class="f18 c-b"><em id="ban">高一（1）班</em></div>
                <%--<button class="b9 fr mtt41">导出</button>--%>
                <button class="b8 fr mtt41" id="printGDG">打印</button>
                <%--<select class="sel1 fr mtt41 mr182" type="text" id="week">--%>
                <%--</select>--%>
...
<script>
    seajs.use('classTable', function (classTable) {
        classTable.init();
    });
</script>
</html>