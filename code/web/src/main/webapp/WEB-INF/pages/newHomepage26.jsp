...
<%--<div style="width: 100%;height: 100%;position: absolute;z-index: -1">
    <img width="100%" height="100%" src="/img/newPage-1.png">
</div>--%>
    ...
    <div class="newPage-main">
        <dl>
            <dt>
                ...
                <span class="newPage-top-right" style="float:right;">
            ...
            <dd>
                <div class="newPage-left">
                    ...
                    <a target="_blank" href="/petbag" class="newPage-left-bottom newPage-shadow">
                        ...
                        <div class="div-jyz">经验值：${sessionValue.experience}</div>
                        <%--<i class="lv-bg">lv.1111</i>--%>
                    </a>

                </div>
                <div class="newPage-right" style="width:800px;height:550px;">
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            <a href="/user?version=1&index=2" class="pageview-IV newPage-right-pageview">
                                ...
                                <!--================好友圈数量====================-->
                                <%--<span class="bg-yuan ">--%>
                                <%--<p class="bo_logo_I">11</p>--%>
                                <%--</span>--%>
                                <%-- <!--================微校园数量====================-->
                                 <div  class="bg-d-I bg-d">
                                     <!--================微校园字体====================-->
                            ...
                            <!--===================校园安全==========================-->
                           <%-- <a href="/schoolSecurity/schoolSecurityPage.do?version=30" class="pageview-I newPage-right-pageview">
                                <img src="../../customizedpage/newspage/img/newLogo-1.png">
                            </a>--%>
                            ...
                            <c:choose>
                                <c:when test="${(roles:isTeacher(sessionValue.userRole))}">
                                    <a href="/homework/teacher.do?version=5&index=3&type=keqian" class="pageview-II newPage-right-pageview">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-5-1.png">
                                    </a>
                                </c:when>
                         ...
                         <%--   <!--===================资源中心==========================-->
                            <a href="/cloud/cloudLesson.do?version=61&type=1" class="pageview-II newPage-right-pageview">
                                <img src="../../customizedpage/newspage/img/newLogo-2.png">
                            </a>--%>
                            <!--=====================互动课堂=========================-->
                            <!--
                           ...
                           <a href="javascript:;" class="pageview-IV newPage-right-pageview newPageHover">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${roles:isStudent(sessionValue.userRole)}">
                                    <a href="/registration/list.do?index=6"  class="newPage-right-pageview">
                            ...
                            -->
                            <!--=====================云资源=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="width: auto;">
                                <img class="" src="../../customizedpage/newspage/img/newLogoo-18-1.png">
                                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
                            </a>
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/cloud/cloudLesson.do?index=9&version=1&type=1" class="newPage-right-pageview" style="width: auto;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18-1.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/cloudres/load.do?index=9&version=3" class="newPage-right-pageview" style="width: auto;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18-1.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                ...
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-II newPage-right-pageview" style="display: block!important;">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-18-1.png">
                                    </a>
                                </c:otherwise>
                            ...
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/myclass/tointerestclass?index=10" class="newPage-right-pageview">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-zizhukecheng.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/myclass/tointerestclass?index=10" class="newPage-right-pageview">
                                ...
                                <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                    <a href="/myclass/toselinclass?index=10&gx_type=1" class="newPage-right-pageview">
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-zizhukecheng.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <!--=====================群组交流=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="display:none;">
                                <img class="" src="../../customizedpage/newspage/img/newLogoo-21-H.png">
                                <img class="newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
                            </a>


                            <a class="newPage-right-pagevieww" href="/chat?index=12" style="width: auto;">
                                <img src="../../customizedpage/newspage/img/newLogoo-21.png" class="newpage-WK newPage-shadow">
                            </a>
                            ...
                            <%--只为复兰大学显示--%>
                            <!--
                            <a href="javascript:;" target="_blank" class="pageview-IV newPage-right-pagevieww newPageHover" style="display:block;">
                           ...
                           -->
                            ...
                            <!--=====================教师评价系统=========================-->
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover" style="width: auto;">
                                <img class="newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-26.png">
                            </a>

                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isTeacher(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/teacherevaluation.do?index=19" class="pageview-IV newPage-right-pagevieww" style="display: block;width: auto;">
                                        <img class="" src="../../customizedpage/newspage/img/newLogoo-26.png">
                                            <img class="newPage-shadow newPageHover-img" src="../../customizedpage/newspage/img/newPage-phone.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="javascript:;" class="pageview-IV newPage-right-pagevieww" style="display: block;width: auto;">
                                        <img class="newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-26.png">
                                    </a>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <a href="javascript:;" class="pageview-IV newPage-right-pagevieww newPageHover">
                                <img class="" src="../../customizedpage/newspage/img/newLogoo-14.png">
                            </a>
                            <c:choose>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole) || roles:isManager(sessionValue.userRole)}">
                                    <a href="/docflow/documentList.do?type=0&index=5&version=1"  class="newPage-right-pagevieww">
                            ...
                            <c:choose>
                                ...
                                (roles:isTeacher(sessionValue.userRole) && roles:isManager(sessionValue.userRole))}">
                                    <a href="/myschool/managesubject?index=18&version=1&tag=1" class="newPage-right-pagevieww" >
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a href="/manageCount/schooltotal.do?index=18&version=1&schoolid=${sessionValue.schoolId}" class="newPage-right-pagevieww" >
                                        <img class="newpage-WK newPage-shadow" src="../../customizedpage/newspage/img/newLogoo-27.png">
                                    </a>
                                </c:when>
                                <c:otherwise>
                            ...
                            <!--=====================成绩分析=========================-->
                             ...
                             <c:choose>
                                  <c:when test="${roles:isTeacher(sessionValue.userRole)}">
                                    <a class="newPage-right-pagevieww" href="/score/teacher.do?index=999" style="width: auto;">
                                       <img src="../../customizedpage/newspage/img/newLogoo-29.png" class="newpage-WK newPage-shadow">
                                    </a>
                                </c:when>
                                <c:when test="${roles:isHeadmaster(sessionValue.userRole)}">
                                     <a class="newPage-right-pagevieww" href="/score/header.do?index=999" style="width: auto;">
                                       <img src="../../customizedpage/newspage/img/newLogoo-29.png" class="newpage-WK newPage-shadow">
                                    </a>
                                </c:when>
                               
                               <c:when test="${roles:isStudentOrParent(sessionValue.userRole)}">
                                    <a class="newPage-right-pagevieww" href="/score/student.do?index=999" style="width: auto;">
                                       <img src="../../customizedpage/newspage/img/newLogoo-29.png" class="newpage-WK newPage-shadow">
                                    </a>
                                </c:when>
                                
                                <c:otherwise>
                                    <a class="newPage-right-pagevieww" href="#" style="width: auto;">
                                       <img src="../../customizedpage/newspage/img/newLogoo-29.png" class="newpage-WK newPage-shadow">
                                    </a>
                                </c:otherwise>
                            </c:choose>
...
<div id="footer" style="font-size: 12px;  clear: both;  overflow: hidden;width: inherit;background-color: #cccccc;opacity: .7;filter: alpha(opacity=70);height: 40px;min-width: 1215px;color:#454545;line-height: 40px;margin-top: 10px;">
...
<script type="text/javascript">
    ...
    function getMicroblogcount() {
        $.ajax({
            ...
            type: "get",
            success: function (data) {
                if(data!=null){if(data.schoolcount>99){
                        $("#wxycount").html("99+");
                    }else {
