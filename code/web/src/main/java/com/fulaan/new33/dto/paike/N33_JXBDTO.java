...
public class N33_JXBDTO {
    ...
    private Integer tkKs;

    private int timeCombSerial;
    ...
    public N33_JXBDTO(N33_JXBEntry e) {
        ...
        this.studentIds = MongoUtils.convertToStringList(e.getStudentIds());
        ...
        this.timeCombSerial = e.getTimeCombSerial();
        this.serialState = e.getSerialState();
    }

    public Integer getTkKs() {
        return tkKs;
    }

    public void setTkKs(Integer tkKs) {
        this.tkKs = tkKs;
    }
    ...
    public Integer getAcClassType() {
        return acClassType;
    }

    public void setAcClassType(Integer acClassType) {
    ...
    public int getTimeCombSerial() {
        return timeCombSerial;
    }

    public void setTimeCombSerial(int timeCombSerial) {
        this.timeCombSerial = timeCombSerial;
    }
